...
int faultSimulate(int failureType, int * failedList, int numProcsFails, int myRank, 
   int numProcs, int startProcs, MPI_Comm comm){
   ...
   if(numProcsFails > 0){
      ...
      MPI_Bcast(failingProcs, numProcsFails, MPI_INT, 0, comm);
